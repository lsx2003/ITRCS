  ...
  return (
    <Fragment>
      <main className={styles.container}>
        <Image src='/img/background-image1.png' className={styles.backgroundImage} fill />
        ...
        <div className={styles.mainContentConatiner}>
          ...
          <div className={styles.contentTitle} style={{ textAlign: 'end', marginTop: '-15px' }}>
            함께하면 어둠을 밝힙니다.
          </div>
          <div className={styles.mainContentWarpper}>
            ...
            <br />
            당신이 생각하는 진정한 교육이란 무엇입니까?
          </div>
          <div className={styles.mainContentButtonWrapper}>
            <div className={styles.mainContentButton}>판례 보러 가기</div>
          </div>
        </div>
      </main>
    </Fragment>
